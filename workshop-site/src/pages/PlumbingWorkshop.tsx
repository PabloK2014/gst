...
const PlumbingWorkshop: React.FC = () => {
    const equipment: Equipment[] = [
        {
            name: 'Трубогиб электрический',
            description: 'Профессиональный трубогиб для работы с металлическими трубами',
            photo: '/src/assets/Мастерские/Сантехника/bender.jpg'
        },
        {
            name: 'Сварочный аппарат для труб',
            description: 'Аппарат для сварки пластиковых труб',
            photo: '/src/assets/Мастерские/Сантехника/welder.jpg'
        },
        {
            name: 'Гидравлический пресс',
            description: 'Пресс для обжима фитингов и соединений',
            photo: '/src/assets/Мастерские/Сантехника/press.jpg'
        },
    ];
    ...
    const masters: Master[] = [
        {
            ...
            photo: '/src/assets/Мастерские/Сантехника/master1.jpg'
        },
        {
            id: 2,
            name: 'Козлов Алексей Иванович',
            photo: '/src/assets/Мастерские/Сантехника/master2.jpg'
        },
    ];

    const workExamples = [
        '/src/assets/Мастерские/Сантехника/example1.jpg',
        '/src/assets/Мастерские/Сантехника/example2.jpg',
        '/src/assets/Мастерские/Сантехника/example3.jpg',
        '/src/assets/Мастерские/Сантехника/example4.jpg',
        '/src/assets/Мастерские/Сантехника/example5.jpg',
        '/src/assets/Мастерские/Сантехника/example6.jpg',
    ];
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {workExamples.map((photo, index) => (
                            ...
                            >
                                <img
                                    src={photo}
                                    alt={`Пример сантехнической работы ${index + 1}`}
...
export default PlumbingWorkshop;