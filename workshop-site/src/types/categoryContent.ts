...
export const categoryContents: Record<string, CategoryContent> = {
  ...
  'каменные работы': {
    ...
    images: [
      '/src/assets/Мастерские/Каменные/mixer.jpg',
      '/src/assets/Мастерские/Каменные/cutter.jpg',
      '/src/assets/Мастерские/Каменные/level.jpg'
    ]
  },
  'столярные работы': {
    ...
    images: [
      '/src/assets/Мастерские/Столярные/milling.jpg',
      '/src/assets/Мастерские/Столярные/lathe.jpg',
      '/src/assets/Мастерские/Столярные/saw.jpg'
    ]
  },
